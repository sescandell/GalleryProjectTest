...
namespace GalleryProject.Droid.DownloadCache
{
    class BsImageCache<T>
        ...
        , IMvxImageCache<T>
    {
        ...
        public BsImageCache(IMvxFileDownloadCache fileDownloadCache, int maxInMemoryFiles, int maxInMemoryBytes)
        {
